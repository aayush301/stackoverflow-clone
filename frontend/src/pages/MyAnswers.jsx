...
const MyAnswers = () => {
  ...
  return (
    <>
      <MainLayout>
        <div className='m-8'>
          <h2 className='mb-3 dark:text-gray-300 font-semibold text-xl rounded-sm'>Answers by me</h2>

          {loading ? (
            <div className='my-40'><Loader className='mx-auto' /></div>
          ) : (
            <>
              <h4 className='text-emerald-400 dark:text-gray-300 text-lg font-semibold'>{answers.length} Answers</h4>
